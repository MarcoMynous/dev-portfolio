...
const DEFAULT_ITEMS: MorphItem[] = [
  {
    ...
    caption: 'Google Developer Student Clubs',
  },
  {
    image: '/images/about/gtco-fintech.jpg',
    caption: 'Guaranty Trust (GTCO / HabariPay)',
  },
  {
    image: '/images/about/goes-consulting.jpg',
    caption: 'GOES Consulting',
  },
];
...
class MorphEngine {
  ...
  constructor(container: HTMLElement, config: EngineConfig) {
    ...
    this.renderer = new Renderer({
      alpha: false,
      antialias: true,
      dpr: Math.min(typeof window !== 'undefined' ? window.devicePixelRatio || 1 : 1, config.dprCap),
    });
    this.gl = this.renderer.gl;
    this.gl.clearColor(0.04, 0.06, 0.12, 1);
