...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  avatarUrl = '/images/about/portrait-clean.png',
  iconUrl,
  grainUrl,
  innerGradient,
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '4px' }}>
                      <div style={{ fontSize: '13px', fontWeight: 600, color: 'rgba(255, 255, 255, 0.95)', lineHeight: 1 }}>
                        @{handle}
                      </div>
                      <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.7)', lineHeight: 1 }}>
                        {status}
                      </div>
                    </div>
                  </div>
              ...
              >
                <h3
                  style={{
                    fontWeight: 700,
                    margin: 0,
                    fontSize: 'min(4.5svh, 2.4em)',
                    backgroundImage: 'linear-gradient(to bottom, #fff, #93b5ff)',
                ...
                <p
                  style={{
                    ...
                    fontWeight: 600,
                    margin: '0 auto',
                    backgroundImage: 'linear-gradient(to bottom, #fff, #7095e0)',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
                    display: 'block',
